# Generated by Django 4.2.3 on 2023-09-24 05:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institute', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.institute')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigIntegerField(primary_key=True, serialize=False)),
                ('ins', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.institute')),
                ('student', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.student')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_msg_fk', models.ForeignKey(blank=True, db_column='student_msg_fk', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.studentmessage')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.instestseriesquestions')),
                ('test_series', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.instestseries')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brief_fk', models.ForeignKey(blank=True, db_column='brief_fk', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.instestseriesuserresponsebrief')),
                ('question', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.instestseriesquestions')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_update_date', models.DateTimeField(blank=True, null=True)),
                ('text', models.CharField(blank=True, max_length=255, null=True)),
                ('feed', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.feed')),
            ],
            options={
