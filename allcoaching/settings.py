"""
Django settings for allcoaching project.
...
WSGI_APPLICATION = 'allcoaching.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "AllCoaching",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "AllCoaching",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Allcoaching",
    ...
    "welcome_sign": "AllCoaching Admin Panel",

    # Copyright on the footer
    "copyright": "allcoaching",
